        ...
        <div className="max-w-md">
            ...
            <form action={accion} className="space-y-5">
                <div>
                    ...
                    {estado.errores?.nombre && <p className="text-xs text-red-500 mt-1">{estado.errores.nombre}</p>}
                </div>
                <div>
                ...
                <div>
                    ...
                    <input name="duracion" type="number" min={1} className={input} required />
                    {estado.errores?.duracion && <p className="text-xs text-red-500 mt-1">{estado.errores.duracion}</p>}
                </div>
                <BotonEnviar />
                {estado.mensaje && <p className="text-sm text-gray-500 mt-2">{estado.mensaje}</p>}
            </form>
        </div>
    );
}